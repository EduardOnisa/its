...
La funzione console.log, prende come input una stringa (nell'esempio la stringa "ciao" e produce una stampa a schermo della stessa.)
*/
...
*/
const prompt = require('prompt-sync')();
resp = prompt("Inserisci una parola")
while (resp != "exit")
{
    vocalicount= 0
    ...
    consonanticount = resp.length - vocalicount
    
    console.log("Il numero di vocali è " + vocalicount)
    console.log("Il numero di consonanti è " + consonanticount) 
